    ...
    <main className="min-h-dvh bg-gray-50 pb-28">
      ...
      <div className="mx-auto max-w-7xl px-5 py-6">
        ...
        <section className="mb-6">
          <h2 className="text-3xl font-semibold leading-tight">Let&rsquo;s Get To Work</h2>
          <p className="mt-1 text-gray-600">Quick actions and today&rsquo;s status at a glance.</p>
        </section>
